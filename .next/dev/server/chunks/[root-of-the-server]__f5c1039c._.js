...
"[project]/src/app/api/match-requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // 二重申請チェック
        const existingRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchRequest.findFirst({
            where: {
        ...
        // 作成
        const newRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchRequest.create({
            data: {
                therapistId: finalTherapistId,
                userId: finalUserId,
                message,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: role === "THERAPIST" ? "利用者へスカウトを送りました！" : "理学療法士にマッチング申請を送りました！",
            data: newRequest
        }, {
            status: 201
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5c1039c._.js.map