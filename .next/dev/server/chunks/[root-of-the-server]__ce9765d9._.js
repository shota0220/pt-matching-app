    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                // 2. いなければセラピストを探す
                const therapist = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].therapist.findUnique({
                    where: {
                        email: credentials.email
                    }
                });
...
"[project]/src/app/api/register/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].therapist.findUnique({
            where: {
                email
            }
        });
        ...
        // 4. 更新処理
        const updatedTherapist = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].therapist.update({
            where: {
                email
            },
            data: {
 ...
 //「誰でも登録できる」のではなく、「ログインしている本人しか、自分のプロフィールを書き換えられない」という**セキュリティの基本（認可）**を押さえている点。
 //位置情報データの保持:
 //「理学療法士の訪問可能エリアを可視化するために、浮動小数点数（Float）で座標を管理するようにしました」という説明は、**「地図アプリの開発能力」**の証明になります。
 //理学療法士のマーケット感覚:
 //「新規登録者のモチベーション維持と、ユーザーへの信頼感のために、初期レーティングを5.0に設定しました」という、プロダクトマネジメント的な視点。
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__ce9765d9._.js.map