...
//ログイン画面
// /Users/shota/Desktop/pt-matching-app/src/app/login/page.tsx
"use client";
;
;
;
...
function LoginPage() {
    ...
    const onSubmit = async (e)=>{
        ...
        if (!result.success) {
            setError(result.error.flatten().fieldErrors.email?.[0] || result.error.flatten().fieldErrors.password?.[0] || "入力内容を確認してください");
            return;
        }
        setIsLoading(true);
        try {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col items-center justify-center min-h-[80vh] px-6 bg-white",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "登録したメールアドレスとパスワードを入力してください。"
                        }, void 0, false, {
                            fileName: "[project]/src/app/login/page.tsx",
                            lineNumber: 68,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    onSubmit: onSubmit,
                    className: "space-y-6 bg-white p-6 border border-slate-200 rounded-lg shadow-sm",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-2",
                            children: [
...
} //この画面で特に素晴らしいのは、「利用者」と「理学療法士」でブランドカラー（ブルーとグリーン）を使い分けている点です。これにより、ユーザーは自分がどちらの立場で操作しているかを直感的に認識できます。また、zod を使ったバリデーションの実装は、フロントエンドエンジニアとしての「基本の徹底」が伝わる良いポイント
 //「ユーザー体験の分岐」をデザインする:
 //「医療系アプリでは、利用者と医療従事者では全く異なるUI/UXが求められます。このログイン画面では、入口でロールを明確に分けることで、その後の複雑な機能（リハビリ予約 or 臨床記録）への心理的な切り替えを促しています」
 //型安全と認証の両立:
 //「zod による厳格な入力バリデーションに加え、next-auth を用いた標準的な認証フローを実装し、医療データを扱う上で必須となるセキュリティをフロントエンドから担保しています」
 //インダストリアル・ミニマリズム:
 //ボタンラベルを「Sign In」から 「Initialize Session（セッションの初期化）」、入力欄を 「Endpoint（エンドポイント）」 など、少しエンジニアライクな言葉遊びを加えました。これにより「専門家が使うツール」としてのブランドイメージを強化しています。
 //UXの微細なインタラクション:
 //group-focus-within を使い、入力欄にフォーカスするとアイコンの色が変わるようにしました。
 //Initialize Session ボタンには、ホバー時に ArrowRight が少し右に動くアニメーションを追加。ユーザーの「次に進む」という意図を視覚的に肯定します。
 //視覚的階層の整理:
 //layout.tsx のロゴが PT. でシンプルなので、ログイン画面では ShieldCheck アイコンをシンボルとして配置し、「医療情報の安全な管理」を暗黙的に伝えています。
 //リダイレクトの最適化:
 //セッション取得後の遷移先を、あなたが開発しているダッシュボード（/dashboard/therapist）へ正確に向かうよう修正しました。
}),
];
