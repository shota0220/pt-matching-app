...
// /Users/shota/Desktop/pt-matching-app/src/app/search/page.tsx
"use client";
;
;
;
;
// Therapist モデルと完全一致させた SPECIALTIES
const SPECIALTIES = [
    "腰痛・膝の痛み（運動器）",
    "脳卒中・麻痺（中枢神経）",
    "歩行困難・転倒予防",
...
function SearchPage() {
    ...
    const [experience, setExperience] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("1");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "max-w-xl mx-auto px-6 pt-16 pb-24",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "条件を入力して、あなたに合ったセラピストを探しましょう。"
                        }, void 0, false, {
                            fileName: "[project]/src/app/search/page.tsx",
                            lineNumber: 74,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: SPECIALTIES.map((spec)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
                                            onClick: ()=>setSpecialty(spec),
                                            className: `p-4 rounded-lg border text-sm text-left transition ${specialty === spec ? "bg-blue-600 text-white border-blue-600" : "bg-slate-50 border-slate-200 hover:bg-slate-100"}`,
                                            children: spec
                                        }, spec, false, {
                                            fileName: "[project]/src/app/search/page.tsx",
                                            lineNumber: 88,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        },
                                        {
                                            ...
                                            className: `flex-1 p-4 rounded-lg border text-sm transition ${experience === item.val ? "bg-blue-600 text-white border-blue-600" : "bg-slate-50 border-slate-200 hover:bg-slate-100"}`,
                                            children: item.label
                                        }, item.val, false, {
                                            fileName: "[project]/src/app/search/page.tsx",
                                            lineNumber: 130,
...
} //ユーザー体験における**「検索（問診）」**の入り口ですね。
 //この SearchPage は、単なるフィルターではなく、理学療法士が最初に行う「問診（アセスメント）」をデジタル化したものと言えます。
 //特に、navigator.geolocation を活用して、「今、困っている場所」と「助けてくれるセラピスト」を地理的に結びつける設計は、福岡というコンパクトシティの特性（天神・博多・西新などの距離感）を活かした素晴らしいアプローチ
 //「身体状況」と「位置」の掛け合わせ:
 //「リハビリテーションは頻度が重要です。患者様の『今の症状』に最適な専門性と、無理なく継続できる『距離』。この2つをGeolocation APIとURLクエリパラメータで制御することで、技術的にも臨床的にも理にかなった検索体験を構築しました。」
 //ユーザーへの心理的配慮:
 //「位置情報の取得という少し不安を感じるアクションに対し、『移動距離を考慮した正確なマッチングのため』という具体的なベネフィットを提示し、ローディング中もアニメーションで『処理が進行していること』を明示するUXを意識しました。」
 //「身体情報のデプロイ」という体験:
 //ボタンのテキストを Find Specialist から Deploy Matching へ、ローディング中を Searching Node... へと変更。単なる検索ではなく、自身の状況をアルゴリズムに投入して最適な答えを導き出す「テック体験」に昇華させました。
 //臨床格付け（Tiering）の強化:
 //Expert を Elite に変更し、Award アイコンを配置。理学療法士としての年数が、ユーザーにとっての「安心感」と「プレミアムな価値」であることを視覚的に強調しました。
 //入力フィールドの質感（Clinical Narrative）:
 //textarea にフォーカスした際、背後にグラデーションの光が漏れる演出を追加。あなたの専門分野である「問診（Narrative）」が、システムにとっても最も重要なデータであることを表現しています。
 //ブランドボイスの徹底:
 //Taxonomy（分類学）、Input Stream（入力ストリーム）、Engine といった言葉を散りばめることで、理学療法士 shota さんが作る「エンジニアリングによる再定義」のメッセージを強化しました。
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc7b72c9._.js.map