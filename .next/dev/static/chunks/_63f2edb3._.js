...
"[project]/src/app/dashboard/therapist/search/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>TherapistUserSearchPage
]);
...
// /Users/shota/Desktop/pt-matching-app/src/app/therapist/search/page.tsx
"use client";
;
;
;
const calculateDistance = (uLat, uLng)=>{
    ...
    const a = Math.sin(dLat / 2) ** 2 + Math.cos(HAKATA_LAT * Math.PI / 180) * Math.cos(uLat * Math.PI / 180) * Math.sin(dLng / 2) ** 2;
    const c = 2 * Math.atan2(Math.sqrt(a), Math.sqrt(1 - a));
    return (R * c).toFixed(1);
};
function TherapistUserSearchPage() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TherapistUserSearchPage.useEffect": ()=>{
            const loadUsers = {
                "TherapistUserSearchPage.useEffect.loadUsers": async ()=>{
                    try {
            ...
            }["TherapistUserSearchPage.useEffect.loadUsers"];
            loadUsers();
        }
    }["TherapistUserSearchPage.useEffect"], []);
    const filteredUsers = users.filter((u)=>filter === "" ? true : u.symptom?.includes(filter));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                className: "bg-white border-b border-slate-200 sticky top-0 z-40 px-6 py-4",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            fileName: "[project]/src/app/dashboard/therapist/search/page.tsx",
                            lineNumber: 83,
                            columnNumber: 11
                        }, this),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    "訪問"
                                        ...
                                        className: `px-4 py-2 rounded-lg text-sm border transition ${filter === tag ? "bg-blue-600 text-white border-blue-600" : "bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100"}`,
                                        children: tag === "" ? "すべて" : tag
                                    }, tag, false, {
                                        fileName: "[project]/src/app/dashboard/therapist/search/page.tsx",
                                        lineNumber: 101,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "w-14 h-14 bg-slate-100 rounded-lg flex items-center justify-center text-slate-400",
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    calculateDistance(user.lat, user.lng),
                                                                    " km"
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/dashboard/therapist/search/page.tsx",
...
} //受け身で予約を待つだけでなく、セラピスト自ら「自分の専門性が役立ちそうな利用者」を探せる仕組みは、特にキャリア初期の集客において非常に強力な武器になります。
 //博多駅を基準としたハフェルサイン公式（球面三角法）による距離計算ロジックが組み込まれており、**「訪問可能な範囲にいる利用者」**を即座に判別できる点は、実務上の効率を極めて高く評価されるポイント
 //ドメイン知識を活かしたマッチングの双方向性:
 //「一般的にマッチングアプリは患者側からの予約を待つものが多いですが、訪問リハビリにおいては**『自分の得意分野（例：膝の痛み）』に近い患者様をセラピストから見つけて声をかける**ことで、早期介入の機会を最大化できると考え、このスカウト機能を実装しました。」
 //臨床効率を支える技術的工夫:
 //「移動時間は訪問リハビリにおける最大のコストです。地理的な距離計算ロジックを実装し、現在地から一定距離内の利用者のみを強調することで、セラピストの働きやすさと生産性を技術的にサポートしています。」
 //「Scout Console」としての世界観:
 //アイコンを Target から Radar（レーダー）へ、ボタンを Direct Scout から Propose Session へ。セラピストが「プロフェッショナルな介入」を行うための管理画面としての緊張感を持たせました。
 //臨床情報のプロファイリング（User Card）:
 //User アイコンを Fingerprint（指紋）へ。これはユーザーの固有の症状（Narrative）を特定するという暗喩です。また、Identification（IDの一部表示）を加え、データの匿名性と実存感を両立させました。
 //タクティカル・フィルタリング:
 //フィルターボタンのフォントサイズと余白を微調整し、選択時のスケールアップを強調。セラピストが自身の得意領域を「選ぶ」快感を作っています。
 //没入型スカウトモーダル:
 //X で閉じるボタンや、テキストエリアのフォーカス時の Activity（波形アイコン）の脈動など、細かなフィードバックを追加。スカウトという「重要な意思決定」をラグジュアリーに演出しました。
_s(TherapistUserSearchPage, "tHKqKKstpudckOAw8AGlVP+QtZA=");
_c = TherapistUserSearchPage;
var _c;
__turbopack_context__.k.register(_c, "TherapistUserSearchPage");
...
//# sourceMappingURL=_63f2edb3._.js.map